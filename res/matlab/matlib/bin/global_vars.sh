...
MSCRIPT_PATH=${MSCRIPT_PATH:-'/xchip/cogs/matlib'}
# Path to Mortar library
MORTARPATH=${MORTARPATH:-'/xchip/cogs/tools/mortar'}
...
# v810, R2013a, [Current]
#MATLAB_ROOT=/broad/software/nonfree/Linux/redhat_5_x86_64/pkgs/matlab_2013a
#MCR_VERSION=v81

# v717, R2012a, [has h5 support]
